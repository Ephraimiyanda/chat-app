            ...
            <div className="flex  gap-3 m-auto w-fit ">
              ...
              <div className="w-[80%] flex flex-col gap-4 h-fit m-auto">
                <div className="flex gap-2">
                  ...
                  <FollowUnfollowBtn following={followerArray && followerArray.includes(user.user._id)?false:true} _id={user.user._id} />
                </div>
        ...
        return (
            ...
            >
              ...
              <FollowerUi
                ...
                name={user.user.name}
                _id={user.user._id}
                following={followerArray && followerArray.includes(userId as string)?false:true}
              />
