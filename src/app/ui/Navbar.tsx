  ...
  return (
    <div className=" grid grid-cols-11 align-middle sm:pt-4 bg-white pb-4  pl-3 pr-3 ml-auto top-0  bottom-0 border-b border-b-stone-300 sm:h-fit h-[55px] pt-[4px]">
      <Image
        ...
        height={20}
      />
      <h1 className="hidden xl:block text-3xl font-bold xl:col-span-2 xl:col-start-2 md:col-start-1  pt-3">
        Herosocial
      </h1>
      <div className="  xl:col-span-5 xl:col-start-4 md:col-start-2  md:col-span-7 md:w-[92%] md:ml-0 md:row-start-1 pt-3  search-div ml-auto mr-auto col-span-7 col-start-2 sm:block hidden xl:ml-[25px] xl:w-[89%]">
        <SearchBar />
      </div>
